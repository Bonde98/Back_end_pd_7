...
from .views import accueil,les_articles, les_details_articles,delete_article,logine,p_article,dt_article,new_article,edit_article,my_contact,about,profile,register_user
...
urlpatterns = [
    ...
    path("asse/",register_user,name="asse"),
